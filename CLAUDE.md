...
> **NEVER edit files inside `pkg/pb/` manually.** They are fully generated by `make proto` (requires Docker). Any manual edits will be overwritten the next time `make proto` runs. Always edit `pkg/proto/service.proto` and regenerate.
